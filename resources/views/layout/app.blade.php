...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SISKEMAS</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2025 SISKEMAS</strong>
    All rights reserved.
...
<script>
  @if(session('toastr_type'))
      var toastrType = "{{ session('toastr_type') }}";
      var toastrMessage = "{{ session('toastr_message') }}";
